...
### Improved
- Reduced log flooding by implementing smarter change detection
- Increased CPU usage change threshold to 20% (from 10%)
- Only log core status on significant threshold crossings
...
### Fixed
- Removed duplicate process termination messages
- Improved shutdown event handler cleanup
